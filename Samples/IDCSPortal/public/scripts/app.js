...
angular.module('idcsPortalApp', ['ui.router','ngResource', 'ui.bootstrap', 'angularUtils.directives.dirPagination', 'ui.grid', 'ui.grid.selection', 'ui.grid.exporter', 'ngAnimate', 'ngTouch', 'chart.js'])
...
.config(function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
        ...
        $stateProvider
           ...
           .state('app.reporting', {
            ...
            .state('app.renderReport', {
                    url:'renderReport/:reportid',
                    views: {
                        'content@': {
